...
const Flag: React.FC<FlagProps> = ({ code, size = 16 }) => {
  const flags: Record<string, string> = {
    ...
    EUR: '<svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg"><rect width="900" height="600" fill="#003399"/><circle cx="450" cy="300" r="120" fill="none" stroke="#FFD700" stroke-width="30"/><circle cx="350" cy="250" r="15" fill="#FFD700"/><circle cx="420" cy="180" r="15" fill="#FFD700"/><circle cx="550" cy="180" r="15" fill="#FFD700"/><circle cx="600" cy="250" r="15" fill="#FFD700"/><circle cx="600" cy="350" r="15" fill="#FFD700"/><circle cx="550" cy="420" r="15" fill="#FFD700"/><circle cx="420" cy="420" r="15" fill="#FFD700"/><circle cx="300" cy="350" r="15" fill="#FFD700"/></svg>',
    BRL: '<svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg"><rect width="900" height="600" fill="#009B3A"/><polygon points="450,100 800,300 450,500 100,300" fill="#FFCC00"/><circle cx="450" cy="300" r="90" fill="#002776"/><rect x="320" y="285" width="260" height="30" fill="#FFFFFF"/><text x="450" y="315" text-anchor="middle" fill="#FFFFFF" font-size="18" font-weight="bold" font-family="Arial">BRASIL</text></svg>',
    ...
    ARS: '<svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg"><rect width="900" height="200" fill="#74ACDF"/><rect y="200" width="900" height="200" fill="#FFFFFF"/><rect y="400" width="900" height="200" fill="#74ACDF"/><circle cx="450" cy="300" r="45" fill="#FFD700"/><polygon points="450,255 458,282 488,282 468,302 476,330 450,310 424,330 432,302 412,282 442,282" fill="#FFD700"/></svg>',
  };
